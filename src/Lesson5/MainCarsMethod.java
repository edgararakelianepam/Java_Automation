...
public class MainCarsMethod {
    ...
    public static void main(String[] args) {
        ...
        bmw.setPower(170);
        bmw.setColor("white");
        base.Cars.BodyType bodyType = bmw.new BodyType("Sedan");
        ...
        base.Cars.BodyType bodyType1 = ford.new BodyType("hatchback");
        ...
        base.Cars.BodyType bodyType2 = mercedes.new BodyType("Sports-car");
        ...
        base.Cars.BodyType bodyType3 = toyota.new BodyType("Cabriolet");
        ...
        base.Cars.YearComparator yearComparator = new Cars.YearComparator(); //static nested class
